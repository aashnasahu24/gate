...
\text{As} \quad e^{-at}u(t) \xrightarrow{\mathcal{L}} \frac{1}{s+a}\\
\intertext{Now}
\mathcal{L}^{-1}(X(s))=x(t)\\
x(t)=-1e^{0}u(t)+\frac{1}{2}e^{-t}u(t)+\frac{1}{2}e^{t}u(t)\\
\implies x(t)=\left(-1+\frac{1}{2}e^-t+\frac{1}{2}e^t\right)u(t)
\end{align}
